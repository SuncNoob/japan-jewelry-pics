...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="cowork", description="无影 Computer Agent multi-agent cowork")
    ...
    pc.add_argument("--scenario", choices=["coding", "crawler", "all"], default="all")
    ...
    ta.add_argument("--scenario", required=True, choices=["coding", "crawler"])
